# Microsoft Developer Studio Project File - Name="test.scratch.links" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=test.scratch.links - Win32 Debug pseudoUNIX
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE
!MESSAGE NMAKE /f "test.scratch.links.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "test.scratch.links.mak" CFG="test.scratch.links - Win32 Debug pseudoUNIX"
!MESSAGE
!MESSAGE Possible choices for configuration are:
!MESSAGE
!MESSAGE "test.scratch.links - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.links - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.links - Win32 Debug pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE
...
!IF  "$(CFG)" == "test.scratch.links - Win32 Release"
...
# ADD CPP /nologo /W3 /GX /O2 /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /I "$(RECLS_ROOT)/include" /I "$(UNIXEM)/include" /D "WIN32" /D "NDEBUG" /D "STRICT" /D "_CONSOLE" /YX /FD /c
...
# ADD LINK32 kernel32.lib advapi32.lib wininet.lib /nologo /version:0.1 /subsystem:console /map /machine:I386 /libpath:"$(RECLS_ROOT)/lib" /libpath:"$(UNIXEM)/lib"
# SUBTRACT LINK32 /pdb:none

!ELSEIF  "$(CFG)" == "test.scratch.links - Win32 Debug"
...
# ADD CPP /nologo /W3 /Gm /GX /Zi /Od /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /I "$(RECLS_ROOT)/include" /I "$(UNIXEM)/include" /D "WIN32" /D "_DEBUG" /D "STRICT" /D "_CONSOLE" /FR /YX /FD /GZ /c
...
# ADD LINK32 kernel32.lib advapi32.lib wininet.lib /nologo /version:0.1 /subsystem:console /map /debug /machine:I386 /out:"Debug/test.scratch.links.debug.exe" /pdbtype:sept /libpath:"$(RECLS_ROOT)/lib" /libpath:"$(UNIXEM)/lib"
# SUBTRACT LINK32 /pdb:none

!ELSEIF  "$(CFG)" == "test.scratch.links - Win32 Debug pseudoUNIX"
...
# PROP Target_Dir ""
# ADD BASE CPP /nologo /W3 /Gm /GX /Zi /Od /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /I "$(RECLS_ROOT)/include" /I "$(UNIXEM)/include" /D "WIN32" /D "_DEBUG" /D "STRICT" /D "_CONSOLE" /FR /YX /FD /GZ /c
# ADD CPP /nologo /W3 /Gm /GX /Zi /Od /I "$(STLSOFT_1_10)/include" /I "$(STLSOFT)/include" /I "$(RECLS_ROOT)/include" /I "$(UNIXEM)/include" /D "UNIX" /D "_DEBUG" /D "STRICT" /D "_CONSOLE" /D "_STLSOFT_FORCE_ANY_COMPILER" /FR /YX /FD /GZ /c
# ADD BASE MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD BASE RSC /l 0xc09 /d "_DEBUG"
# ADD RSC /l 0xc09 /d "_DEBUG"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib advapi32.lib wininet.lib /nologo /version:0.1 /subsystem:console /map /debug /machine:I386 /out:"Debug/test.scratch.links.debug.exe" /pdbtype:sept /libpath:"$(RECLS_ROOT)/lib" /libpath:"$(UNIXEM)/lib"
...
# Name "test.scratch.links - Win32 Release"
# Name "test.scratch.links - Win32 Debug"
# Name "test.scratch.links - Win32 Debug pseudoUNIX"
...
SOURCE="$(RECLS_ROOT)\include\recls\cpp\unix.hpp"
# End Source File
# Begin Source File
