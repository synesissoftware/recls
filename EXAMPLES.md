...
|**example_c_9**|C|[examples/c/example_c_9/main.c](./examples/c/example_c_9/main.c)<br/>[examples/c/example_c_9.md](./examples/c/example_c_9.md)|Demonstrates recursive search for all sockets under a given directory including all appropriate failure handling.|
|**example_c_10**|C|[examples/c/example_c_10/main.c](./examples/c/example_c_10/main.c)<br/>[examples/c/example_c_10.md](./examples/c/example_c_10.md)|Demonstrates recursive search for all devices under a given directory including all appropriate failure handling.|
