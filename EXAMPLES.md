...
|**example_c_2**|C|[examples/c/example_c_2/main.c](./examples/c/example_c_2/main.c)<br/>[examples/c/example_c_2.md](./examples/c/example_c_2.md)|Demonstrates callback recursive search, via `Recls_SearchFeedback()`, and display of each full path.|
|**example_c_3**|C|[examples/c/example_c_3/main.c](./examples/c/example_c_3/main.c)<br/>[examples/c/example_c_3.md](./examples/c/example_c_3.md)|Demonstrates use of `Recls_Stat()`, `Recls_Search()`, `Recls_SqueezePath()`, `Recls_CalcDirectoryEntrySize()`.|
|**example_c_4**|C|[examples/c/example_c_4/main.c](./examples/c/example_c_4/main.c)<br/>[examples/c/example_c_4.md](./examples/c/example_c_4.md)|Demonstrates non-recursive search for directories (`RECLS_F_DIRECTORIES`) and elimination of non-empty directories by `Recls_IsDirectoryEntryEmpty()`.|
